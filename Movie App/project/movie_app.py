# from project import Movie, User
...
class MovieApp:
    ...
    def check_is_movie_exist(self, title):
        for movie in self.movies_collection:
            if movie.title == title:
                return True
        return False

    def check_if_user_like_the_movie(self, username, movie_title):
        for user in self.users_collection:
            if user.username == username:
    ...
    def upload_movie(self, username, movie):
        ...
        elif self.check_is_movie_exist(movie.title):
    ...
    def edit_movie(self, username, movie, **kwargs):
        if not self.check_is_movie_exist(movie.title):
    ...
    def like_movie(self, username, movie):
        ...
        elif self.check_if_user_like_the_movie(username, movie.title):
    ...
    def dislike_movie(self, username, movie):
        if not self.check_if_user_like_the_movie(username, movie.title):
