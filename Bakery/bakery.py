...
class Bakery:
    ...
    # def __add_product(self, product_type, name, names_set, product_menu, factory, **kwargs):
    #     if name in names_set:
    #         raise Exception(f'{product_type} {name} is already in the menu!')
    #
    #     product = factory.create(product_type, name, **kwargs)
    #     product_menu.append(product)
    #     names_set.add(name)
    #     return f'Added {name} ({product_type}) to the food menu'
